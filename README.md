# RXQ v1.0 
## Build RESTful web applications with XQuery RESTXQ Annotations
...
*  [src/dashML](https://github.com/xquery/rxq/tree/master/src/dashML) - non trivial [dashML](https://github.com/xquery/dashML) application (dashboard metrics) using RXQ.
